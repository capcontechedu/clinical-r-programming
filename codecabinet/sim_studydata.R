...
if (num > 5) {
  num = 5
  warning("Number entered exceeds the requirement, creating 5 (Maximum threshold) study data folders")
} else if (num < 2) {
  num = 2
  warning("Number entered less than threshold, creating 2 (Minimum threshold) study data folders")
} 
